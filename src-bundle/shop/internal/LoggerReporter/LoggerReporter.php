...
namespace shop\internal\LoggerReporter;


use shop\internal\LoggerReporter\module\AbstractMessage;
use shop\internal\LoggerReporter\module\MessageConsole;
use shop\internal\LoggerReporter\module\MessageDiscord;
...
class LoggerReporter
{
     ...
     */
    final public function console($message, $level = 1): MessageConsole
    {
     ...
     */
    final public function discord($message, $level = 2): MessageDiscord
    {
